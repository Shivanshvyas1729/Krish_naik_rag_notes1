...
<details>
<summary>💡 LangChain v0.3 Partner Packages</summary>
<ul>
<li><strong>Partner Packages</strong>: Using <code>langchain_chroma</code>, <code>langchain_pinecone</code>, <code>langchain_qdrant</code>, etc., is the current supported standard in v0.3, moving away from monolithic <code>langchain_community</code> imports where possible.</li>
</ul>
</details>
